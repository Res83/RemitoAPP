 ...
 */
public class Ventana_Proveedores3 extends javax.swing.JFrame
{
...
dft.addRow(Filas);
        ...
        r.close();
         ...
         {
             Logger.getLogger(Ventana_Proveedores3.class.getName()).log(Level.SEVERE, null, ex);
         }
}    
...
EditarRegistro(); 
    ...
    {//GEN-HEADEREND:event_jTable_TabladeRegistrosMouseClicked
        ...
        // evento Mouse Clicked en la Tabla:
             ...
             jTextField_Empresa.setText(String.valueOf(jTable_TabladeRegistros.getValueAt(seleccion,0)));             
            jTextField_txtCodigo_Proveedor.setText(String.valueOf(jTable_TabladeRegistros.getValueAt(seleccion,1)));
                jTextField_Empresa.requestFocus();
...
public static void main(String args[])
{
    ...
    {
        java.util.logging.Logger.getLogger(Ventana_Proveedores3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    }
    ...
    public void run()
    {
        new Ventana_Proveedores3().setVisible(true);
    }
    });
}
    ...
    private void EliminarRegistro()
    {
        ...
        if(cone2!=null)
        {
         ...
         //       ReAbrirVentanaCategorias();
                 ...
                 jTextField_Empresa.setText("(Escribe la Nueva Ubicación)");
