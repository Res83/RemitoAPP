 ...
 */
public class Ventana_Marcas extends javax.swing.JFrame
{
...
public Ventana_Marcas()
{
    initComponents();
    
//Crea y carga Base de Datos /////////////////////////////////////////////////////////////

    conex.CrearDB_Base_datos_Marcas();
...
//Monstrar Algo de una Base de Datos:
    try (Statement orden = cone2.createStatement())
    {
        ...
        while (r.next())
        {
            Object Filas[]={r.getString("Marcas"),r.getString("ID")};
...
private void FiltrarRegistro(String Establezco_Filtro)
{
    ...
    if(cone2!=null)
    {
        try
        {
            ...
            String Filtro = "Select* From Lista_de_Marcas where Marcas LIKE '%"+jTextField_txtCuadro.getText().trim()+"%' ";
...
// Update (Nombre de la Tabla) Set
            ...
            String editar ="Update Lista_de_Marcas Set Marcas='"+jTextField_txtCuadro.getText()+"' where ID="+jTextField_Cuadro_ID.getText()+"";
...
// Cargo la base de datos mas arriba para tenerla disponible en todo.       
        ...
        {
        JOptionPane.showMessageDialog(this, "Debe escribir la Marca antes de agregar");
        }else 
        {
        if(cone2!=null)
  {
      try
      {
          try (Statement orden = cone2.createStatement())
          {
              String crear = "Insert into Lista_de_Marcas(Marcas,ID) Values("
...
//   IniciarContador(contador_de_filas);
PropiedadesTabla();
JOptionPane.showMessageDialog(this, "Nueva Marca Agregada: [ "+jTextField_txtCuadro.getText()+" ]");
...
public static void main(String args[])
{
    ...
    {
        java.util.logging.Logger.getLogger(Ventana_Marcas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    }
    ...
    public void run()
    {
        new Ventana_Marcas().setVisible(true);
    }
    });
}
    ...
    private void EliminarRegistro()
    {
        ...
        if(cone2!=null)
        {
            try
            {
                ...
                String Elminar = "DELETE From Lista_de_Marcas Where ID="+jTextField_Cuadro_ID.getText();
...
public int id_incrementable()
{
    ...
    {
      Statement orden = cone2.createStatement();
      ResultSet r = orden.executeQuery("Select MAX(ID) From Lista_de_Marcas");
        while (r.next())
        {            
                    id=r.getInt(1)+1;
